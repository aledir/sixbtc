...
| File | Contenuto |
|------|-----------|
| [Overview](index.md) | Schema sintetico (questo file) |
| [Generator](01-generator.md) | Generator daemon e strategy sources |
| [Validator](02-validator.md) | Validation pipeline (syntax, AST, execution) |
| [Parametric](03-parametric.md) | Parametric optimization |
| [Backtest IS](04-backtest-is.md) | Backtest In-Sample |
| [Backtest OOS](05-backtest-oos.md) | Backtest Out-of-Sample |
| [Score](06-score.md) | Score calculation |
| [Shuffle Test](07-shuffle.md) | Shuffle test (lookahead detection) |
| [Walk-Forward](08-wfa.md) | Walk-Forward Analysis |
| [Robustness](08b-robustness.md) | Robustness Check (final gate) |
| [Pool Entry](09-pool.md) | Pool entry (leaderboard) |
| [Rotation](10-rotation.md) | Rotation to LIVE |
| [Auxiliary](aux.md) | Flussi ausiliari (data, retest, sync, etc.) |
| [Risk](../reference/risk.md) | Risk management e emergency stops |

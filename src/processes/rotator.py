#!/usr/bin/env python3
"""
Rotator Process Entry Point

Supervisor-managed continuous process for strategy rotation.
"""
...
def main():
    ...
    from src.rotator.main_continuous import ContinuousRotatorProcess

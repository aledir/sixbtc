"""
Pattern-Gen Strategy: Contraction Alert + ROC Cross Zero Down
Type: VRE (template)
Timeframe: 2h
Direction: short
Blocks: CONTRACTION_ALERT, ROC_CROSS_ZERO_DOWN
Generated: 2026-01-13T03:24:29.820115+00:00
"""
...
class PGnStrat_VRE_0131cb85b5899911(StrategyCore):
    """
    Pattern: Contraction Alert + ROC Cross Zero Down
    Direction: short
    Lookback: 60 bars
    ...
    def generate_signal(self, df: pd.DataFrame, symbol: str = None) -> Signal | None:
        ...
        return Signal(
            ...
            reason='Contraction Alert + ROC Cross Zero Down',
        )
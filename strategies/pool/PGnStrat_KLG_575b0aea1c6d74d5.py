"""
Pattern-Gen Strategy: Klinger Oscillator Negative + Stochastic Overbought
Type: KLG (template)
Timeframe: 2h
Direction: short
Blocks: KLINGER_NEGATIVE, STOCH_OVERBOUGHT
Generated: 2026-01-13T02:14:21.930659+00:00
"""
...
class PGnStrat_KLG_575b0aea1c6d74d5(StrategyCore):
    """
    Pattern: Klinger Oscillator Negative + Stochastic Overbought
    Direction: short
    Lookback: 70 bars
    ...
    def generate_signal(self, df: pd.DataFrame, symbol: str = None) -> Signal | None:
        ...
        return Signal(
            ...
            reason='Klinger Oscillator Negative + Stochastic Overbought',
        )
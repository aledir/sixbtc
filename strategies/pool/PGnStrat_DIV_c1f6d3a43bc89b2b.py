"""
Pattern-Gen Strategy: CCI Bearish Divergence + Volume Breakout Down
Type: DIV (template)
Timeframe: 2h
Direction: short
Blocks: CCI_BEARISH_DIVERGENCE, VOLUME_BREAKOUT_DOWN
Generated: 2026-01-13T00:51:48.960408+00:00
"""
...
class PGnStrat_DIV_c1f6d3a43bc89b2b(StrategyCore):
    """
    Pattern: CCI Bearish Divergence + Volume Breakout Down
    Direction: short
    Lookback: 80 bars
    ...
    def generate_signal(self, df: pd.DataFrame, symbol: str = None) -> Signal | None:
        ...
        return Signal(
            ...
            reason='CCI Bearish Divergence + Volume Breakout Down',
        )
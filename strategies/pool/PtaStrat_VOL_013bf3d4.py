"""
PtaStrat: Keltner Channels + Detrended Price Oscillator
Timeframe: 30m
Direction: SHORT
Regime: TREND
Exit Mechanism: TP and EC
Generated: 2026-01-13T04:15:34.251631+00:00
"""
...
class PtaStrat_VOL_013bf3d4(StrategyCore):
    """
    Entry: 2 indicator(s)
...
TP: Fibonacci Extension    """
    ...
    def calculate_indicators(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        # Condition 1: Keltner Channels threshold_above 70
        cond_1 = df['kc'] > 70
    ...
    def generate_signal(self, df: pd.DataFrame, symbol: str = None) -> Signal | None:
        ...
        signal_kwargs = {
            ...
            'reason': 'KC(threshold_above) + DPO(threshold_above)',
        }

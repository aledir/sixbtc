"""
Pattern-Gen Strategy: A/D Bearish Divergence + Williams %R Overbought
Type: WAD (template)
Timeframe: 2h
Direction: short
Blocks: WAD_BEARISH_DIVERGENCE, WILLR_OVERBOUGHT
Generated: 2026-01-13T03:33:27.935897+00:00
"""
...
class PGnStrat_WAD_f50678662051ba51(StrategyCore):
    """
    Pattern: A/D Bearish Divergence + Williams %R Overbought
    Direction: short
    Lookback: 60 bars
    ...
    def generate_signal(self, df: pd.DataFrame, symbol: str = None) -> Signal | None:
        ...
        return Signal(
            ...
            reason='A/D Bearish Divergence + Williams %R Overbought',
        )
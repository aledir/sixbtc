"""
Pattern-Gen Strategy: Institutional Volume (threshold2.0)
Type: SMB (parametric)
Timeframe: 2h
Direction: long
Blocks: INSTITUTIONAL_VOL
Generated: 2026-01-13T08:07:59.831959+00:00
"""
...
class PGnStrat_SMB_c80f4d5b0f178c35(StrategyCore):
    """
    Pattern: Institutional Volume (threshold2.0)
    Direction: long
    Lookback: 30 bars
    ...
    def generate_signal(self, df: pd.DataFrame, symbol: str = None) -> Signal | None:
        ...
        return Signal(
            ...
            reason='Institutional Volume (threshold2.0)',
        )